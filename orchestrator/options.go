...
// [praxis.InvocationRequest] does not specify a model.
...
// WithMaxTurns sets the default maximum number of LLM round-trips
// allowed per invocation.
//
// Values below 1 are clamped to 1; values above 100 are clamped to 100.
// An individual [praxis.InvocationRequest] may override this value
// by setting its own MaxTurns field.
...
// WithMaxIterations is an alias for [WithMaxTurns] for backward compatibility.
//
// Deprecated: Use WithMaxTurns instead.
func WithMaxIterations(n int) Option {
	return WithMaxTurns(n)
}
...
// estimates. Passing nil returns an error.
